    ...
    <div className="flex h-screen max-h-screen">
      ...
      <section className="remove-scrollbar container my-auto">
        <div className="sub-container max-w-[496px]">
          <Image className="h-10 md:h-13 mb-12 w-max" width={1000} height={1000} alt="DocSpot Logo" src={'/assets/logo.svg'}></Image>
          <PatientForm/>
      ...
      <Image src='/assets/home-img.svg' height={1000} width={1000} alt='doctor image' className="side-img max-w-[50%]"/>
    </div>
  );
}
